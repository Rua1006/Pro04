...
import com.hami.service.FreeService;
...
public class FreeController {
	...
	public String getfreeList(@RequestParam("bno") int bno, Model model) throws Exception{
		FreeDTO dto = freeService.getFree(bno);
	...
	public void imageUpload(HttpServletRequest request,
		...
		try {
			...
			//이미지 경로 생성
			String path = "D:\\kbs\\pro04\\pro04\\src\\main\\webapp\\resources\\upload"+"ckImage/"; //이미지 경로 설정
	...
	throws ServletException, IOException{
		...
		//서버에서 저장된 이미지 경로
		String path = "D:\\kbs\\pro04\\pro04\\src\\main\\webapp\\resources\\upload"+"ckImage/";	// 저장된 이미지 경로
